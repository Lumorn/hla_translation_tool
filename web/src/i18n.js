...
(function() {
    const resources = {
        de: {
            ...
            'deAudio.quick.header': 'Quick access',
            'deAudio.quick.subheadline': 'Key steps are available as compact buttons and highlight the matching detail sections on click.',
            'deAudio.quick.trim': 'Trim',
            'deAudio.quick.auto': 'Auto',
            'deAudio.quick.segment': 'Segments',
            'deAudio.quick.tempo': 'Tempo',
            'deAudio.quick.tempoMinus': 'Reduce tempo stepwise',
            'deAudio.quick.tempoPlus': 'Increase tempo stepwise',
            'deAudio.quick.tempo120': 'Set tempo to 1.20 directly',
            'deAudio.quick.tempo130': 'Set tempo to 1.30 directly',
            'deAudio.quick.volume': 'Level',
            'deAudio.quick.radio': 'Radio',
            'deAudio.effects.volume.legend': '🔊 Match volume',
            'deAudio.effects.volume.button': 'Match volume',
            'deAudio.effects.volume.buttonTitle': 'Match level to EN',
            'deAudio.effects.volume.note': 'Booster or attenuator for tricky takes.',
            'deAudio.effects.boost.toggle': 'Enable booster',
            'deAudio.effects.boost.toggleTitle': 'Toggle manual booster',
            'deAudio.effects.boost.gainLabel': 'Gain:',
            'deAudio.effects.boost.gainTitle': 'Manual gain in dB',
            'deAudio.effects.boost.sliderTitle': 'Adjust gain manually',
            'deAudio.effects.boost.preset.minus6': '-6 dB',
            'deAudio.effects.boost.preset.minus3': '-3 dB',
            'deAudio.effects.boost.preset.plus3': '+3 dB',
            'deAudio.effects.boost.preset.plus6': '+6 dB',
            'deAudio.effects.boost.reset': 'Neutral (0 dB)',
            'deAudio.effects.boost.resetTitle': 'Reset booster to neutral value',
            'deAudio.effects.radio.legend': '📡 Radio effect',
            'deAudio.effects.radio.mixLabel': 'Wet:',
            'deAudio.effects.radio.mixTitle': 'Blend amount',
            'deAudio.effects.radio.highpassLabel': 'Highpass (Hz):',
            'deAudio.effects.radio.highpassTitle': 'High-pass frequency',
            'deAudio.effects.radio.lowpassLabel': 'Lowpass (Hz):',
            'deAudio.effects.radio.lowpassTitle': 'Low-pass frequency',
            'deAudio.effects.radio.saturationLabel': 'Saturation:',
            'deAudio.effects.radio.saturationTitle': 'Saturation amount',
            'deAudio.effects.radio.noiseLabel': 'Noise (dB):',
            'deAudio.effects.radio.noiseTitle': 'Noise level in dBFS',
            'deAudio.effects.radio.crackleLabel': 'Crackle:',
            'deAudio.effects.radio.crackleTitle': 'Crackle intensity',
            'deAudio.effects.radio.presetSelect': 'Saved presets',
            'deAudio.effects.radio.presetSave': '💾 Save',
            'deAudio.effects.radio.presetSaveTitle': 'Save current settings',
            'deAudio.effects.radio.presetDelete': '🗑 Delete',
            'deAudio.effects.radio.presetDeleteTitle': 'Delete selected preset',
            'deAudio.effects.radio.apply': 'Apply radio effect',
            'deAudio.effects.radio.applyTitle': 'Apply radio effect',
            'deAudio.effects.radio.reset': '⟳ Defaults',
            'deAudio.effects.radio.resetTitle': 'Reset only this effect',
            'deAudio.effects.volume.legend': '🔊 Lautstärke angleichen',
            'deAudio.effects.volume.button': 'Lautstärke angleichen',
            'deAudio.effects.volume.buttonTitle': 'Pegel an EN anpassen',
            'deAudio.effects.volume.note': 'Booster oder Absenker für schwierige Aufnahmen.',
            'deAudio.effects.boost.toggle': 'Booster aktivieren',
            'deAudio.effects.boost.toggleTitle': 'Manuellen Booster ein- oder ausschalten',
            'deAudio.effects.boost.gainLabel': 'Verstärkung:',
            'deAudio.effects.boost.gainTitle': 'Manuelle Verstärkung in dB',
            'deAudio.effects.boost.sliderTitle': 'Manuellen Pegel anpassen',
            'deAudio.effects.boost.preset.minus6': '-6 dB',
            'deAudio.effects.boost.preset.minus3': '-3 dB',
            'deAudio.effects.boost.preset.plus3': '+3 dB',
            'deAudio.effects.boost.preset.plus6': '+6 dB',
            'deAudio.effects.boost.reset': 'Neutral (0 dB)',
            'deAudio.effects.boost.resetTitle': 'Booster auf Neutralwert zurücksetzen',
            ...
            'deAudio.effects.radio.saturationLabel': 'Sättigung:',
            'deAudio.effects.radio.saturationTitle': 'Sättigungsgrad',
            'deAudio.effects.radio.noiseLabel': 'Rauschen (dB):',
            'deAudio.effects.radio.noiseTitle': 'Rauschpegel in dBFS',
            'deAudio.effects.radio.crackleLabel': 'Knackser:',
            'deAudio.effects.radio.crackleTitle': 'Häufigkeit der Knackser',
            'deAudio.effects.radio.presetSelect': 'Gespeicherte Presets',
            'deAudio.effects.radio.presetSave': '💾 Speichern',
            'deAudio.effects.radio.presetSaveTitle': 'Aktuelle Einstellungen speichern',
            'deAudio.effects.radio.presetDelete': '🗑 Löschen',
            'deAudio.effects.radio.presetDeleteTitle': 'Gewähltes Preset löschen',
            'deAudio.effects.radio.apply': 'Funkgerät-Effekt anwenden',
            'deAudio.effects.radio.applyTitle': 'Funkgerät-Effekt anwenden',
            'deAudio.effects.radio.reset': '⟳ Standardwerte',
            'deAudio.effects.radio.resetTitle': 'Setzt nur diesen Effekt zurück',

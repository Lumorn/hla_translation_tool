...
(function() {
    const resources = {
        de: {
            ...
            'copyAssistant.complete': 'Fertig',
            'copyAssistant.fileProgress': 'Datei {current} von {total}',
            'copyAssistant.stepProgress': 'Schritt {current} / {total}',
        ...
        en: {
            ...
            'copyAssistant.complete': 'Done',
            'copyAssistant.fileProgress': 'File {current} of {total}',
            'copyAssistant.stepProgress': 'Step {current} / {total}',

...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Datei-Input einmalig verbinden (zusätzlich im HTML mit onchange hinterlegt)
...
async function openSegmentDialog() {
    ...
    // Listener sicherstellen und Wert leeren, damit auch dieselbe Datei erneut erkannt wird
    input.removeEventListener('change', analyzeSegmentFile);

...
async function timeStretchBuffer(buffer, factor) {
    ...
    // frueher wurde hier zusaetzliche Stille angehaengt, um das Time-Stretching
    // robuster zu machen. Dieser Puffer von 100 ms fuehrte jedoch zu einer
    // ungewollten Verzoegerung am Anfang. Wir verzichten nun darauf und
    // stretchen direkt das Original.
    const padded = buffer;

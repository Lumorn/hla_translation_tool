        ...
        <td>
            <div class="action-column">
                <div class="action-group">
                    <button class="upload-btn" onclick="initiateDeUpload(${file.id})" title="DE-Audio hochladen">⬆️</button>
                    ${hasHistory ? `<button class="history-btn" onclick="openHistory(${file.id})" title="Historie anzeigen">🕒</button>` : ''}
                </div>
                <div class="action-group">
                    <div class="dubbing-cell">
                        <button class="dubbing-btn" onclick="initiateDubbing(${file.id})" title="Dubbing starten">🔈</button>
                        ${file.emotionalText && file.emotionalText.trim() ? `<button class="dubbing-btn emo" onclick="initiateEmoDubbing(${file.id})" title="Emotionales Dubbing starten">🟣</button>` : ''}
                        ...
                        ${file.dubbingId ? `<button class="download-de-btn" data-file-id="${file.id}" title="Dubbing herunterladen (ID: ${file.dubbingId})" onclick="openDubbingPage(${file.id})">⬇️</button>` : ''}
                        ...
                        ${file.emoDubbingId ? `<button class="download-emo-btn" data-file-id="${file.id}" title="Emo-Dubbing herunterladen (ID: ${file.emoDubbingId})" onclick="openDubbingPage(${file.id}, 'emo')">⬇️</button>` : ''}
                    </div>
                </div>
                <div class="action-group" style="align-items:flex-start;">
                    <button class="edit-audio-btn" onclick="openDeEdit(${file.id})" title="DE-Audio bearbeiten">✂️</button>
                    ...
                    ${file.emotionalText && file.emotionalText.trim() ? `<button class="emo-done-btn" onclick="toggleEmoCompletion(${file.id})" title="Zeile fertig vertont">Fertig (DE)</button>` : ''}
                </div>
                <div class="action-group">
                    <button class="delete-row-btn" onclick="deleteFile(${file.id})" title="Zeile löschen">🗑️</button>
                </div>
            </div>
        </td>
    </tr>

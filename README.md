...
![Half‑Life: Alyx Translation Tool](https://img.shields.io/badge/Version-1.40.8-green?style=for-the-badge)
...
* **GPT-Bewertungen:** Zeilen lassen sich per ChatGPT bewerten. Beim Überfahren zeigt ein Tooltip Kommentar und Vorschlag, ein Klick ersetzt den DE-Text und blinkt kurz blau auf
...
Dort gibt es jetzt auch einen Bereich **ChatGPT API**. Der Schlüssel wird lokal AES‑verschlüsselt im Nutzerordner gespeichert. Der Prompt für die Bewertung liegt in `prompts/gpt_score.txt`.

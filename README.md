...
| **Großer Zahlenbereich**       | Level-Reihenfolgen können bis **9999** gesetzt werden. |
...
### 3.7.1 (aktuell) - Level‑UI-Verbesserungen

**✨ Neue Features:**
* **Level-Reihenfolge sichtbar**: Dropdowns und Level-Kopfzeilen zeigen jetzt die zugehörige Zahl, z.B. `1.Levelname`.
* **Großer Zahlenbereich**: Reihenfolgen bis **9999** möglich.
...
**Version 3.7.1** - Level‑UI-Verbesserungen Edition

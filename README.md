...
Der Datei-Input verknüpft den Listener jetzt schon beim Laden der Seite und wird bei jedem Öffnen nur geleert, sodass auch dieselbe Datei erneut ausgewählt werden kann.

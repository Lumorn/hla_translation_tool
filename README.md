...
* **ZIP-Import mit temporärem Ordner:** Die ausgewählte ZIP-Datei wird in den Ordner `ZipTemp` im Benutzerverzeichnis entpackt und dort geöffnet. Die enthaltenen Audios ordnest du anschließend manuell über „Audio-Datei zuordnen“ zu. Mehrteilige Archive werden weiterhin ignoriert.

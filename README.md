...
Die Dateiauswahl reagiert dank eines festen `onchange`-Attributs und eines zusätzlichen Listeners sofort und wird bei jedem Öffnen zurückgesetzt, damit auch dieselbe Datei erneut ausgewählt werden kann.

...
10. `python verify_environment.py` zeigt jede Prüfung mit einem ✓ an, prüft nun auch, ob Git installiert ist und im aktuellen Ordner ein Repository existiert. Zudem werden wichtige Dateien sowie der Git‑Status kontrolliert, ohne Änderungen vorzunehmen.

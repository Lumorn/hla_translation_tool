...
Der Datei-Input verknüpft den Listener jetzt schon beim Laden der Seite und wird bei jedem Öffnen nur geleert, sodass auch dieselbe Datei erneut ausgewählt werden kann. Zusätzlich sorgt ein `onchange`-Attribut am Input dafür, dass die Analyse auch dann startet, wenn der Listener einmal nicht gesetzt werden sollte.

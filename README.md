...
* **Tempo-Sicherungen sind abschaltbar:** Im Tempo-Kasten stehen jetzt vier Häkchen bereit – Auto-Tempo-Referenz ohne Randstille, Sekundenpuffer vor dem Stretching, Randstille-Analyse sowie Trim-Limit. Du kannst jeden Schutz gezielt deaktivieren, falls das Rohsignal unangetastet bleiben soll oder du bewusst ohne Grenzen stretchen möchtest.
* **Trim-Limit ohne Kappung deaktivieren:** Ist das Sicherheitslimit ausgeschaltet, reicht das Tool die komplette erkannte Randstille ohne 120-ms-Kappe weiter oder gibt bei fehlender Analyse explizit „unbegrenzt“ frei. Debug-Ausgaben und Tooltips weisen deutlich darauf hin, dass keine feste Begrenzung mehr greift, und auch Vorschau, Tempo-Debug sowie beide Speicherroutinen übernehmen jetzt die unbegrenzte Freigabe ohne versteckten 120-ms-Deckel.
...
* **Neu aufgesetztes Trim & Padding:** `trimAndPadBuffer` entfernt nur noch explizit gesetzte Trims, füllt Verlängerungen ausschließlich mit Stille auf und bewahrt dabei den rechten Rand auch dann, wenn du eine DE-Datei auf die Länge des EN-Originals bringst.

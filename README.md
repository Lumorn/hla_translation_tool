...
* **Schneller Zugriff:** Die Schnellzugriffsleiste sitzt in einem flachen Panel ohne Schatten und mit deutlich weniger Padding. Die Buttons treten als 36–40 px hohe Icon-Kacheln mit optionalem Untertitel (`quick-btn--label`) auf, sodass Trim ✂️, Auto ⚡, Tempo ⏱️, Pegel 🔊 und Funk 📻 dicht beieinander stehen, ohne den Kartenbereich zu überlagern. Unter 600 px Breite blendet die Leiste die Texte aus und bietet ein horizontal scrollbares Icon-Band.
